...
slave_mysql_exec "STOP SLAVE; CHANGE MASTER TO master_host = '$server', master_port = 3306, master_user='repl', master_password='repl-of-itsnow',master_log_file='$log_file',master_log_pos=$log_pos ;START SLAVE;"
