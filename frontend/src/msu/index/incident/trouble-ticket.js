...
angular.module('MsuIndex.Incident', [
  'MsuIndex.Incident.Model',
  'MsuIndex.Incident.Service',
  'Index.Table',
  'Index.Dialog'
])
...
//                {field: 'status', displayName: '状态',cellTemplate: '<div ng-class="{new : row.getProperty(col.field) === \'New\'}"><div class="ngCellText">{{row.getProperty(col.field)}}</div></div>'},
                {field: 'status', displayName: '状态',cellTemplate: StatusChangeService.perform()},
