 ...
 */
var contractApp = angular.module('ItsNow.Contract', ['ngGrid','ngResource']);

var ContractListCtrl = ['$scope', '$http', 'ContractService', function ($scope, $http, ContractService) {
    $scope.filterOptions = {
        filterText: "",
...
contractApp.factory('ContractService', ['$resource', function ($resource) {
    return $resource('/api/contract', null, {
        list: {
            method: 'GET',
            isArray: true
        }
