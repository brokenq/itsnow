angular.module('MscApp.Templates', ['account/list.tpl.html', 'contract/list-contract.tpl.html', 'sla/list-sla.tpl.html', 'user/list-user.tpl.html']);

angular.module("account/list.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("account/list.tpl.html",
    "<div ng-controller=\"AccountListCtrl\" class=\"container\">\n" +
    "  <table ng-table=\"ng-table\" class=\"table\">\n" +
    "    <tr ng-repeat=\"account in accounts\">\n" +
    "      <td data-title=\"'SN'\">{{account.sn}}</td>\n" +
    "      <td data-title=\"'Name'\">{{account.name}}</td>\n" +
    "      <td data-title=\"'Domain'\">{{account.domain}}</td>\n" +
    "    </tr>\n" +
    "  </table>\n" +
    "</div>");
}]);
