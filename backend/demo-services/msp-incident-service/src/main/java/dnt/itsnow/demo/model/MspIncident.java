 ...
 */
public class MspIncident extends Record {

    private Long msuAccountId;
    private Long msuIncidentId;
    private String msuInstanceId;
    ...
    private MspIncidentStatus status = MspIncidentStatus.Assigned;
    ...
    public MspIncidentStatus getStatus() {
        return status;
    }

    public void setStatus(MspIncidentStatus status) {
        this.status = status;
    }
    ...
    public Long getMsuIncidentId() {
        return msuIncidentId;
    }

    public void setMsuIncidentId(Long msuIncidentId) {
        this.msuIncidentId = msuIncidentId;
    }
