...
public class RoleRepositoryConfig extends RepositoryConfigWithH2 {
    ...
    protected String[] sqlScripts() {
        return new String[]{
                "classpath:META-INF/migrate/20140902154504_create_roles.sql@up",
                "classpath:META-INF/migrate/20140912100500_insert_roles.sql@up",
                ...
                "classpath:META-INF/migrate/20140722135425_create_group_authorities.sql@up",
                "classpath:META-INF/migrate/20140728161939_insert_group_authorities.sql@up"
        };
    }
}
