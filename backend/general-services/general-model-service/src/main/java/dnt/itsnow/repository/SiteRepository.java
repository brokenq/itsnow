...
public interface SiteRepository {
    ...
    @Insert("INSERT INTO sites (sn, name, address, description, work_time_id, area, created_at, updated_at) VALUES " +
            "(#{sn}, #{name}, #{address}, #{description}, #{workTime.id}, #{area} ,#{createdAt}, #{updatedAt})")
