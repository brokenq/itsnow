 ...
 */
public class PrivateServiceCatalogTest extends ValidatorSupport{
    ...
    public void testValidationHappyCase() throws Exception {
        Set<ConstraintViolation<PrivateServiceCatalog>> violations = validator.validate(catalog);
    ...
    public void testJson() throws Exception {
        ...
        PrivateServiceCatalog parsed = JsonSupport.parseJson(json, PrivateServiceCatalog.class);
