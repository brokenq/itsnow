...
import itsnow.dnt.config.MsuWorkflowManagerConfig;
 ...
 * <h1>Class Usage</h1>
 */
@ContextConfiguration(classes = MsuWorkflowManagerConfig.class)
@ActiveProfiles("test")
@RunWith(SpringJUnit4ClassRunner.class)
public class MsuWorkflowManagerTest {

    @Autowired
    MsuWorkflowService service;
