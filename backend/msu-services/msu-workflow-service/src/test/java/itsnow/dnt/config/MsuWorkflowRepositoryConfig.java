...
public class MsuWorkflowRepositoryConfig extends RepositoryConfigWithH2 {
    ...
    protected String[] sqlScripts() {
        return new String[]{
                ...
                "classpath:META-INF/setup/insert_private_service_catalogs.sql@up",
                "classpath:META-INF/setup/insert_private_service_items.sql@up",
